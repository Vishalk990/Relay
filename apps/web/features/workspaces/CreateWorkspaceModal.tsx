...
export function CreateWorkspaceModal({ existingNames, onClose, onCreate }: CreateWorkspaceModalProps) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      setSubmitting(true);
      await onCreate(trimmed); // parent closes the modal on success
    } catch {
      setError("Couldn't create workspace. Try again.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <p className="mt-1 text-sm text-zinc-400">Give your workspace a name. You can change it later.</p>
